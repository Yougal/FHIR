angular.module("sampleApp").service('supportSvc', function($http,$q,appConfigSvc,GetDataFromServer,Utilities,$window) {
    ...
    var optionalValues;
    $http.get( $window.location.origin+_contextPath+"/artifacts/options.json").then(
        function(data) {
